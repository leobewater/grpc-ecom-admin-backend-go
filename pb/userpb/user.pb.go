...
func (x *UserLoginResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x38, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72,
	0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f,
	0x72, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f,
	0x72, 0x64, 0x22, 0x32, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52,
	...
	0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x2b, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f,
	...
	0x75, 0x6c, 0x74, 0x32, 0x4d, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x39, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_proto_user_proto_depIdxs = []int32{
	0, // 0: user.UserLoginRequest.user:type_name -> user.User
	1, // 1: user.UserLoginService.User:input_type -> user.UserLoginRequest
	2, // 2: user.UserLoginService.User:output_type -> user.UserLoginResponse
...
type UserLoginServiceClient interface {
	// Unary
	User(ctx context.Context, in *UserLoginRequest, opts ...grpc.CallOption) (*UserLoginResponse, error)
}
...
func (c *userLoginServiceClient) User(ctx context.Context, in *UserLoginRequest, opts ...grpc.CallOption) (*UserLoginResponse, error) {
	out := new(UserLoginResponse)
	err := c.cc.Invoke(ctx, "/user.UserLoginService/User", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserLoginServiceServer interface {
	// Unary
	User(context.Context, *UserLoginRequest) (*UserLoginResponse, error)
}
...
func (*UnimplementedUserLoginServiceServer) User(context.Context, *UserLoginRequest) (*UserLoginResponse, error) {
...
func _UserLoginService_User_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserLoginServiceServer).User(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.UserLoginService/User",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserLoginServiceServer).User(ctx, req.(*UserLoginRequest))
	}
...
var _UserLoginService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "User",
			Handler:    _UserLoginService_User_Handler,
		},
	},
